    ...
    const onSubmit = (data) =>{
        ...
        .then(imgRes =>{
            if (imgRes.success) {
                ...
                const {title, details, deadditional_descriptiongree, capabilities_details, main_points, images} = data;
                const newServiceData = {title, details, deadditional_descriptiongree, capabilities_details, main_points, image:imgUrl}
                console.log(newServiceData);
                axiosSecure.post(`/service`, newServiceData)
                .then(data=>{
